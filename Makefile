...
generate:
	...
	oapi-codegen --include-tags agents,tenants,lens,secrets,environments,mcp-connections,workflows,workflow-schedules,session -config oapi-codegen.gateway.yaml openapi/gateway.yaml
