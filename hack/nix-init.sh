...
readonly cache_schema='agentz-nix-init-v6-unfree-pruned-env'
...
write_env_expr() {
...

    {
        ...
        echo '    { }'
        echo '    runtimeSpecs;'
        echo '  wrapTarExtraction = drv:'
        echo '    if builtins.isAttrs drv && (drv ? overrideAttrs) then'
        echo '      drv.overrideAttrs'
        echo '        (old: {'
        echo '          env = (old.env or { }) // {'
        echo '            TAR_OPTIONS ='
        echo '              let'
        echo '                current ='
        echo '                  if old ? env && old.env ? TAR_OPTIONS then'
        echo '                    old.env.TAR_OPTIONS'
        echo '                  else'
        echo '                    old.TAR_OPTIONS or "";'
        echo '                extra = "--no-same-owner --no-same-permissions";'
        echo '              in'
        echo '                if current == "" then'
        echo '                  extra'
        echo '                else'
        echo '                  current + " " + extra;'
        echo '          };'
        ...
        echo '    (spec: wrapTarExtraction spec.drv)'
