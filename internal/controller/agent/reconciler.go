...
// +kubebuilder:rbac:groups=agentz.accuknox.com,resources=agents,verbs=create-dashboard;create-workflow;create-workflow-schedule;delete-dashboard;delete-dashboard-data;delete-workflow-schedule;delete-workflows;get-dashboard;get-workflow;list-dashboards;list-workflow-schedules;list-workflows;replace-dashboard;set-workflowrun-status;update-workflow-schedule;write-dashboard-data
