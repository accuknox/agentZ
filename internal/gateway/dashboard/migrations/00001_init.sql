...
-- +goose Down
DROP FUNCTION IF EXISTS dashboard_account_deleted_data() CASCADE;
DROP TABLE IF EXISTS dashboard_publish_idempotency;
DROP TABLE IF EXISTS dashboard_query_leases;
DROP TABLE IF EXISTS dashboard_query_windows;
DROP TABLE IF EXISTS dashboard_publish_windows;
DROP TABLE IF EXISTS dashboard_agent_usage;
DROP TABLE IF EXISTS dashboard_tenant_usage;
DROP TABLE IF EXISTS dashboard_latest_records;
DROP TABLE IF EXISTS dashboard_temporal_records;
