...
CREATE INDEX observer_traces_session_started_idx
  ON observer_traces(tenant_namespace, agent_name, started_at DESC);
...
CREATE TABLE observer_mcp_tool_last_called(
  ...
  updated_at TIMESTAMPTZ NOT NULL DEFAULT now(),
  PRIMARY KEY(tenant_namespace, agent_name, mcp_connection_name, tool_name),
  FOREIGN KEY(tenant_namespace, agent_name)
    REFERENCES agents(tenant_namespace, agent_name)
    ON DELETE CASCADE
);
...
-- +goose Down
DROP INDEX observer_mcp_tool_last_called_agent_connection_time_idx;
DROP TABLE observer_mcp_tool_last_called;
DROP INDEX observer_mcp_tool_invocations_time_brin_idx;
DROP INDEX observer_mcp_tool_invocations_agent_connection_tool_time_idx;
DROP INDEX observer_mcp_tool_invocations_agent_time_connection_tool_idx;
DROP TABLE observer_mcp_tool_invocations_default;
DROP TABLE observer_mcp_tool_invocations;
...
DROP INDEX observer_trace_spans_agent_class_time_idx;
DROP INDEX observer_trace_spans_agent_session_time_idx;
...
DROP INDEX observer_trace_sessions_started_brin_idx;
DROP INDEX observer_trace_sessions_agent_session_started_idx;
DROP INDEX observer_trace_sessions_agent_started_trace_idx;
DROP TABLE observer_trace_sessions;
