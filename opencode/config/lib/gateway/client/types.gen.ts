...
export type ListProcessObservabilityResponse = {
  events: Array<
    ProcessObservabilityEvent | ProcessObservabilityEventAggregated
  >;
  next_page_token: string;
};
...
export type ListNetworkObservabilityResponse = {
  events: Array<
    NetworkObservabilityEvent | NetworkObservabilityEventAggregated
  >;
  next_page_token: string;
};
...
export type ListTracesResponse2 =
  ListTracesResponses[keyof ListTracesResponses];
...
export type ListTraceSessionsError =
  ListTraceSessionsErrors[keyof ListTraceSessionsErrors];
...
export type GetSpanDetailResponse =
  GetSpanDetailResponses[keyof GetSpanDetailResponses];
...
export type WatchAgentsResponse =
  WatchAgentsResponses[keyof WatchAgentsResponses];
...
export type ListSecretsResponse2 =
...
export type ListEnvironmentsResponse2 =
