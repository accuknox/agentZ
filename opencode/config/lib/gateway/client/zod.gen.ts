...
export const zListProcessObservabilityResponse = z.object({
  events: z.array(
    z.union([zProcessObservabilityEvent, zProcessObservabilityEventAggregated]),
  ),
  next_page_token: z.string(),
});
...
export const zListFileObservabilityResponse = z.object({
  events: z.array(
    z.union([zFileObservabilityEvent, zFileObservabilityEventAggregated]),
  ),
  next_page_token: z.string(),
});
...
export const zListNetworkObservabilityResponse = z.object({
  events: z.array(
    z.union([zNetworkObservabilityEvent, zNetworkObservabilityEventAggregated]),
  ),
  next_page_token: z.string(),
});
 ...
 */
export const zListProcessObservabilityResponse2 =
  zListProcessObservabilityResponse;
 ...
 */
export const zListNetworkObservabilityResponse2 =
  zListNetworkObservabilityResponse;
