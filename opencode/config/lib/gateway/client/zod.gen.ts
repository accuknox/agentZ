...
export const zDashboardDefinition = z.object({
  ...
  filters: z.array(zDashboardFilter),
...
export const zDashboardQueryRequest = z.object({
  ...
  filters: z.array(zDashboardQueryFilter),
})
...
export const zListDashboardsHeaders = z.object({
  "X-AgentZ-Workspace-ID": z.string().min(1).max(128),
})
...
export const zQueryDashboardWidgetBody = zDashboardQueryRequest

export const zQueryDashboardWidgetHeaders = z.object({
  "X-AgentZ-Workspace-ID": z.string().min(1).max(128),
})
...
export const zListDashboardFilterOptionsBody = zDashboardTimeRange

export const zListDashboardFilterOptionsHeaders = z.object({
  "X-AgentZ-Workspace-ID": z.string().min(1).max(128),
})

export const zListDashboardFilterOptionsPath = z.object({
  dashboardId: z.string().min(1).max(128),
  filterId: zDashboardIdentifier,
})
...
export const zListAgentDashboardsHeaders = z.object({
  "X-AgentZ-Session-ID": z.string().min(1).max(256),
})
...
export const zCreateAgentDashboardBody = zDashboardDefinition

export const zCreateAgentDashboardHeaders = z.object({
  "X-AgentZ-Session-ID": z.string().min(1).max(256),
})

export const zCreateAgentDashboardPath = z.object({
  agentName: zAgentName,
})
...
export const zDeleteAgentDashboardHeaders = z.object({
  "X-AgentZ-Session-ID": z.string().min(1).max(256),
})

export const zDeleteAgentDashboardPath = z.object({
  agentName: zAgentName,
...
export const zGetAgentDashboardHeaders = z.object({
  "X-AgentZ-Session-ID": z.string().min(1).max(256),
})

export const zGetAgentDashboardPath = z.object({
  agentName: zAgentName,
  dashboardName: zDashboardName,
})
...
export const zReplaceAgentDashboardBody = zReplaceDashboardRequest

export const zReplaceAgentDashboardHeaders = z.object({
  "X-AgentZ-Session-ID": z.string().min(1).max(256),
})

export const zReplaceAgentDashboardPath = z.object({
  agentName: zAgentName,
  dashboardName: zDashboardName,
})
...
export const zDeleteDashboardDataBody = zDeleteDashboardDataRequest

export const zDeleteDashboardDataHeaders = z.object({
  "X-AgentZ-Session-ID": z.string().min(1).max(256),
})

export const zDeleteDashboardDataPath = z.object({
  agentName: zAgentName,
  dashboardName: zDashboardName,
})
...
export const zWriteDashboardDataBody = zWriteDashboardDataRequest

export const zWriteDashboardDataHeaders = z.object({
  "X-AgentZ-Session-ID": z.string().min(1).max(256),
})

export const zWriteDashboardDataPath = z.object({
  agentName: zAgentName,
  dashboardName: zDashboardName,
})
