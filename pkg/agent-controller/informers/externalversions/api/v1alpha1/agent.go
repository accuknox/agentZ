...
import (
	...
	clawarmorapiv1alpha1 "github.com/accuknox/clawarmor/api/v1alpha1"
	...
	apiv1alpha1 "github.com/accuknox/clawarmor/pkg/agent-controller/listers/api/v1alpha1"
...
type AgentInformer interface {
	...
	Lister() apiv1alpha1.AgentLister
}
	...
	return cache.NewSharedIndexInformer(
		cache.ToListWatcherWithWatchListSemantics(&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ApiV1alpha1().Agents(namespace).List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ApiV1alpha1().Agents(namespace).Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ApiV1alpha1().Agents(namespace).List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ApiV1alpha1().Agents(namespace).Watch(ctx, options)
			},
		}, client),
		&clawarmorapiv1alpha1.Agent{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *agentInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&clawarmorapiv1alpha1.Agent{}, f.defaultInformer)
}

func (f *agentInformer) Lister() apiv1alpha1.AgentLister {
	return apiv1alpha1.NewAgentLister(f.Informer().GetIndexer())
}
