...
import (
	v1alpha1 "github.com/accuknox/agentz/pkg/controller/clientset/versioned/typed/agentz/v1alpha1"
	rest "k8s.io/client-go/rest"
	testing "k8s.io/client-go/testing"
)

type FakeAgentzV1alpha1 struct {
	*testing.Fake
}

func (c *FakeAgentzV1alpha1) Agents(namespace string) v1alpha1.AgentInterface {
...
func (c *FakeAgentzV1alpha1) RESTClient() rest.Interface {
