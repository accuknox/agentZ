...
type InferencePoolInformer interface {
	...
	Lister() agentzv1alpha1.InferencePoolLister
}
...
func NewInferencePoolInformerWithOptions(client versioned.Interface, namespace string, options internalinterfaces.InformerOptions) cache.SharedIndexInformer {
	gvr := schema.GroupVersionResource{Group: "agentz", Version: "v1alpha1", Resource: "inferencepools"}
	...
	return cache.NewSharedIndexInformerWithOptions(
		cache.ToListWatcherWithWatchListSemantics(&cache.ListWatch{
			ListFunc: func(opts v1.ListOptions) (runtime.Object, error) {
				...
				return client.AgentzV1alpha1().InferencePools(namespace).List(context.Background(), opts)
			},
			WatchFunc: func(opts v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&opts)
				}
				return client.AgentzV1alpha1().InferencePools(namespace).Watch(context.Background(), opts)
			},
			ListWithContextFunc: func(ctx context.Context, opts v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&opts)
				}
				return client.AgentzV1alpha1().InferencePools(namespace).List(ctx, opts)
			},
			WatchFuncWithContext: func(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&opts)
				}
				return client.AgentzV1alpha1().InferencePools(namespace).Watch(ctx, opts)
			},
		}, client),
		&apisagentzv1alpha1.InferencePool{},
...
func (f *inferencePoolInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apisagentzv1alpha1.InferencePool{}, f.defaultInformer)
}

func (f *inferencePoolInformer) Lister() agentzv1alpha1.InferencePoolLister {
	return agentzv1alpha1.NewInferencePoolLister(f.Informer().GetIndexer())
}
