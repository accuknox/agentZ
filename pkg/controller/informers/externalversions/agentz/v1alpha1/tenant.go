...
type TenantInformer interface {
	...
	Lister() agentzv1alpha1.TenantLister
}
...
func NewTenantInformerWithOptions(client versioned.Interface, options internalinterfaces.InformerOptions) cache.SharedIndexInformer {
	gvr := schema.GroupVersionResource{Group: "agentz", Version: "v1alpha1", Resource: "tenants"}
	...
	return cache.NewSharedIndexInformerWithOptions(
		cache.ToListWatcherWithWatchListSemantics(&cache.ListWatch{
			ListFunc: func(opts v1.ListOptions) (runtime.Object, error) {
				...
				return client.AgentzV1alpha1().Tenants().List(context.Background(), opts)
			},
			WatchFunc: func(opts v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&opts)
				}
				return client.AgentzV1alpha1().Tenants().Watch(context.Background(), opts)
			},
			ListWithContextFunc: func(ctx context.Context, opts v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&opts)
				}
				return client.AgentzV1alpha1().Tenants().List(ctx, opts)
			},
			WatchFuncWithContext: func(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&opts)
				}
				return client.AgentzV1alpha1().Tenants().Watch(ctx, opts)
			},
		}, client),
		&apisagentzv1alpha1.Tenant{},
...
func (f *tenantInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apisagentzv1alpha1.Tenant{}, f.defaultInformer)
}

func (f *tenantInformer) Lister() agentzv1alpha1.TenantLister {
	return agentzv1alpha1.NewTenantLister(f.Informer().GetIndexer())
}
