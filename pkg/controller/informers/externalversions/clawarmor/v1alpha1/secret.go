...
type SecretInformer interface {
	...
	Lister() clawarmorv1alpha1.SecretLister
}
...
func NewSecretInformerWithOptions(client versioned.Interface, namespace string, options internalinterfaces.InformerOptions) cache.SharedIndexInformer {
	gvr := schema.GroupVersionResource{Group: "clawarmor", Version: "v1alpha1", Resource: "secrets"}
	...
	return cache.NewSharedIndexInformerWithOptions(
		cache.ToListWatcherWithWatchListSemantics(&cache.ListWatch{
			ListFunc: func(opts v1.ListOptions) (runtime.Object, error) {
				...
				return client.ClawarmorV1alpha1().Secrets(namespace).List(context.Background(), opts)
			},
			WatchFunc: func(opts v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&opts)
				}
				return client.ClawarmorV1alpha1().Secrets(namespace).Watch(context.Background(), opts)
			},
			ListWithContextFunc: func(ctx context.Context, opts v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&opts)
				}
				return client.ClawarmorV1alpha1().Secrets(namespace).List(ctx, opts)
			},
			WatchFuncWithContext: func(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&opts)
				}
				return client.ClawarmorV1alpha1().Secrets(namespace).Watch(ctx, opts)
			},
		}, client),
		&apisclawarmorv1alpha1.Secret{},
...
func (f *secretInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apisclawarmorv1alpha1.Secret{}, f.defaultInformer)
}

func (f *secretInformer) Lister() clawarmorv1alpha1.SecretLister {
	return clawarmorv1alpha1.NewSecretLister(f.Informer().GetIndexer())
}
