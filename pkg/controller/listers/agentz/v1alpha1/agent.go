...
type AgentLister interface {
	...
	List(selector labels.Selector) (ret []*agentzv1alpha1.Agent, err error)
...
type agentLister struct {
	listers.ResourceIndexer[*agentzv1alpha1.Agent]
}

// NewAgentLister returns a new AgentLister.
func NewAgentLister(indexer cache.Indexer) AgentLister {
	return &agentLister{listers.New[*agentzv1alpha1.Agent](indexer, agentzv1alpha1.Resource("agent"))}
}

// Agents returns an object that can list and get Agents.
func (s *agentLister) Agents(namespace string) AgentNamespaceLister {
	return agentNamespaceLister{listers.NewNamespaced[*agentzv1alpha1.Agent](s.ResourceIndexer, namespace)}
}
...
type AgentNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*agentzv1alpha1.Agent, error)
