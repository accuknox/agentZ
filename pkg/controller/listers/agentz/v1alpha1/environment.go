...
type EnvironmentLister interface {
	...
	List(selector labels.Selector) (ret []*agentzv1alpha1.Environment, err error)
...
type environmentLister struct {
	listers.ResourceIndexer[*agentzv1alpha1.Environment]
}

// NewEnvironmentLister returns a new EnvironmentLister.
func NewEnvironmentLister(indexer cache.Indexer) EnvironmentLister {
	return &environmentLister{listers.New[*agentzv1alpha1.Environment](indexer, agentzv1alpha1.Resource("environment"))}
}

// Environments returns an object that can list and get Environments.
func (s *environmentLister) Environments(namespace string) EnvironmentNamespaceLister {
	return environmentNamespaceLister{listers.NewNamespaced[*agentzv1alpha1.Environment](s.ResourceIndexer, namespace)}
}
...
type EnvironmentNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*agentzv1alpha1.Environment, error)
