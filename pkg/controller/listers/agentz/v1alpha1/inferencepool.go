...
type InferencePoolLister interface {
	...
	List(selector labels.Selector) (ret []*agentzv1alpha1.InferencePool, err error)
...
type inferencePoolLister struct {
	listers.ResourceIndexer[*agentzv1alpha1.InferencePool]
}
...
func NewInferencePoolLister(indexer cache.Indexer) InferencePoolLister {
	return &inferencePoolLister{listers.New[*agentzv1alpha1.InferencePool](indexer, agentzv1alpha1.Resource("inferencepool"))}
}

// InferencePools returns an object that can list and get InferencePools.
func (s *inferencePoolLister) InferencePools(namespace string) InferencePoolNamespaceLister {
	return inferencePoolNamespaceLister{listers.NewNamespaced[*agentzv1alpha1.InferencePool](s.ResourceIndexer, namespace)}
}
...
type InferencePoolNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*agentzv1alpha1.InferencePool, error)
