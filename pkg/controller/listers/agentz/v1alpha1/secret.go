...
type SecretLister interface {
	...
	List(selector labels.Selector) (ret []*agentzv1alpha1.Secret, err error)
...
type secretLister struct {
	listers.ResourceIndexer[*agentzv1alpha1.Secret]
}

// NewSecretLister returns a new SecretLister.
func NewSecretLister(indexer cache.Indexer) SecretLister {
	return &secretLister{listers.New[*agentzv1alpha1.Secret](indexer, agentzv1alpha1.Resource("secret"))}
}

// Secrets returns an object that can list and get Secrets.
func (s *secretLister) Secrets(namespace string) SecretNamespaceLister {
	return secretNamespaceLister{listers.NewNamespaced[*agentzv1alpha1.Secret](s.ResourceIndexer, namespace)}
}
...
type SecretNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*agentzv1alpha1.Secret, error)
