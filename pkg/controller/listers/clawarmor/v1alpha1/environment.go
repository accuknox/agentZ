...
type EnvironmentLister interface {
	...
	List(selector labels.Selector) (ret []*clawarmorv1alpha1.Environment, err error)
...
type environmentLister struct {
	listers.ResourceIndexer[*clawarmorv1alpha1.Environment]
}

// NewEnvironmentLister returns a new EnvironmentLister.
func NewEnvironmentLister(indexer cache.Indexer) EnvironmentLister {
	return &environmentLister{listers.New[*clawarmorv1alpha1.Environment](indexer, clawarmorv1alpha1.Resource("environment"))}
}

// Environments returns an object that can list and get Environments.
func (s *environmentLister) Environments(namespace string) EnvironmentNamespaceLister {
	return environmentNamespaceLister{listers.NewNamespaced[*clawarmorv1alpha1.Environment](s.ResourceIndexer, namespace)}
}
...
type EnvironmentNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*clawarmorv1alpha1.Environment, error)
