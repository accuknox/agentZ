...
type SecretLister interface {
	...
	List(selector labels.Selector) (ret []*clawarmorv1alpha1.Secret, err error)
...
type secretLister struct {
	listers.ResourceIndexer[*clawarmorv1alpha1.Secret]
}

// NewSecretLister returns a new SecretLister.
func NewSecretLister(indexer cache.Indexer) SecretLister {
	return &secretLister{listers.New[*clawarmorv1alpha1.Secret](indexer, clawarmorv1alpha1.Resource("secret"))}
}

// Secrets returns an object that can list and get Secrets.
func (s *secretLister) Secrets(namespace string) SecretNamespaceLister {
	return secretNamespaceLister{listers.NewNamespaced[*clawarmorv1alpha1.Secret](s.ResourceIndexer, namespace)}
}
...
type SecretNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*clawarmorv1alpha1.Secret, error)
