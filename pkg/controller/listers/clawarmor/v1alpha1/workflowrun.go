...
type WorkflowRunLister interface {
	...
	List(selector labels.Selector) (ret []*clawarmorv1alpha1.WorkflowRun, err error)
...
type workflowRunLister struct {
	listers.ResourceIndexer[*clawarmorv1alpha1.WorkflowRun]
}

// NewWorkflowRunLister returns a new WorkflowRunLister.
func NewWorkflowRunLister(indexer cache.Indexer) WorkflowRunLister {
	return &workflowRunLister{listers.New[*clawarmorv1alpha1.WorkflowRun](indexer, clawarmorv1alpha1.Resource("workflowrun"))}
}

// WorkflowRuns returns an object that can list and get WorkflowRuns.
func (s *workflowRunLister) WorkflowRuns(namespace string) WorkflowRunNamespaceLister {
	return workflowRunNamespaceLister{listers.NewNamespaced[*clawarmorv1alpha1.WorkflowRun](s.ResourceIndexer, namespace)}
}
...
type WorkflowRunNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*clawarmorv1alpha1.WorkflowRun, error)
