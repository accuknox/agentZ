...
ALTER TABLE "invitation_teams" ADD CONSTRAINT "invitation_teams_invitation_id_organization_invitations_id_fk" FOREIGN KEY ("invitation_id") REFERENCES "public"."organization_invitations"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "workspace_inherited_resources_organization_resource_idx" ON "workspace_inherited_resources" USING btree ("organization_id","resource","resource_name");--> statement-breakpoint
