...
export const listCodingRepositoriesQueryKey = (options?: Options<ListCodingRepositoriesData>) =>
  createQueryKey("listCodingRepositories", options)

export const listCodingRepositoriesOptions = (options?: Options<ListCodingRepositoriesData>) =>
  queryOptions<
    ListCodingRepositoriesResponse,
    ListCodingRepositoriesError,
    ListCodingRepositoriesResponse,
    ReturnType<typeof listCodingRepositoriesQueryKey>
  >({
    queryFn: async ({ queryKey, signal }) => {
      const { data } = await listCodingRepositories({
        ...options,
        ...queryKey[0],
        signal,
        throwOnError: true,
    ...
    queryKey: listCodingRepositoriesQueryKey(options),
  })
...
export const listCodingRepositoriesInfiniteQueryKey = (
  options?: Options<ListCodingRepositoriesData>
): QueryKey<Options<ListCodingRepositoriesData>> =>
  createQueryKey("listCodingRepositories", options, true)

export const listCodingRepositoriesInfiniteOptions = (
  options?: Options<ListCodingRepositoriesData>
) =>
  infiniteQueryOptions<
    ListCodingRepositoriesResponse,
    ListCodingRepositoriesError,
    InfiniteData<ListCodingRepositoriesResponse>,
    QueryKey<Options<ListCodingRepositoriesData>>,
    | number
    | Pick<QueryKey<Options<ListCodingRepositoriesData>>[0], "body" | "headers" | "path" | "query">
  >(
    // @ts-ignore
    {
      queryFn: async ({ pageParam, queryKey, signal }) => {
        // @ts-ignore
        const page: Pick<
          QueryKey<Options<ListCodingRepositoriesData>>[0],
      ...
      queryKey: listCodingRepositoriesInfiniteQueryKey(options),
    }
  )

export const listCodingRefsQueryKey = (options: Options<ListCodingRefsData>) =>
  createQueryKey("listCodingRefs", options)

export const listCodingRefsOptions = (options: Options<ListCodingRefsData>) =>
  queryOptions<
    ListCodingRefsResponse,
    ListCodingRefsError,
    ListCodingRefsResponse,
    ReturnType<typeof listCodingRefsQueryKey>
  >({
    queryFn: async ({ queryKey, signal }) => {
      const { data } = await listCodingRefs({
        ...options,
        ...queryKey[0],
        signal,
        throwOnError: true,
    ...
    queryKey: listCodingRefsQueryKey(options),
  })

export const listCodingRefsInfiniteQueryKey = (
  options: Options<ListCodingRefsData>
): QueryKey<Options<ListCodingRefsData>> => createQueryKey("listCodingRefs", options, true)

export const listCodingRefsInfiniteOptions = (options: Options<ListCodingRefsData>) =>
  infiniteQueryOptions<
    ListCodingRefsResponse,
    ListCodingRefsError,
    InfiniteData<ListCodingRefsResponse>,
    QueryKey<Options<ListCodingRefsData>>,
    string | Pick<QueryKey<Options<ListCodingRefsData>>[0], "body" | "headers" | "path" | "query">
  >(
    // @ts-ignore
    {
      queryFn: async ({ pageParam, queryKey, signal }) => {
        // @ts-ignore
        const page: Pick<
          QueryKey<Options<ListCodingRefsData>>[0],
          "body" | "headers" | "path" | "query"
        > =
          typeof pageParam === "object"
            ? pageParam
      ...
      queryKey: listCodingRefsInfiniteQueryKey(options),
    }
  )

export const refreshCodingRepositoryMutation = (
  options?: Partial<Options<RefreshCodingRepositoryData>>
): UseMutationOptions<
  RefreshCodingRepositoryResponse,
  RefreshCodingRepositoryError,
  Options<RefreshCodingRepositoryData>
> => {
  const mutationOptions: UseMutationOptions<
    RefreshCodingRepositoryResponse,
    RefreshCodingRepositoryError,
  ...
  > = {
    mutationFn: async (fnOptions) => {
      const { data } = await refreshCodingRepository({
        ...options,
        ...fnOptions,
        throwOnError: true,
      })
...
export const adoptCodingWorktreeMutation = (
  options?: Partial<Options<AdoptCodingWorktreeData>>
): UseMutationOptions<
  AdoptCodingWorktreeResponse,
  AdoptCodingWorktreeError,
  Options<AdoptCodingWorktreeData>
> => {
  const mutationOptions: UseMutationOptions<
    AdoptCodingWorktreeResponse,
    AdoptCodingWorktreeError,
  ...
  > = {
    mutationFn: async (fnOptions) => {
      const { data } = await adoptCodingWorktree({
        ...options,
        ...fnOptions,
        throwOnError: true,
      })
...
export const listCodingOperationsQueryKey = (options?: Options<ListCodingOperationsData>) =>
  createQueryKey("listCodingOperations", options)

export const listCodingOperationsOptions = (options?: Options<ListCodingOperationsData>) =>
  queryOptions<
    ListCodingOperationsResponse,
    ListCodingOperationsError,
    ListCodingOperationsResponse,
    ReturnType<typeof listCodingOperationsQueryKey>
  >({
    queryFn: async ({ queryKey, signal }) => {
      const { data } = await listCodingOperations({
        ...options,
        ...queryKey[0],
        signal,
        throwOnError: true,
    ...
    queryKey: listCodingOperationsQueryKey(options),
  })

export const startCodingOperationMutation = (
  options?: Partial<Options<StartCodingOperationData>>
): UseMutationOptions<
  StartCodingOperationResponse,
  StartCodingOperationError,
  Options<StartCodingOperationData>
> => {
  const mutationOptions: UseMutationOptions<
    StartCodingOperationResponse,
    StartCodingOperationError,
  ...
  > = {
    mutationFn: async (fnOptions) => {
      const { data } = await startCodingOperation({
        ...options,
        ...fnOptions,
        throwOnError: true,
      })
...
export const getCodingOperationQueryKey = (options: Options<GetCodingOperationData>) =>
  createQueryKey("getCodingOperation", options)

export const getCodingOperationOptions = (options: Options<GetCodingOperationData>) =>
  queryOptions<
    GetCodingOperationResponse,
    GetCodingOperationError,
    GetCodingOperationResponse,
    ReturnType<typeof getCodingOperationQueryKey>
  >({
    queryFn: async ({ queryKey, signal }) => {
      const { data } = await getCodingOperation({
        ...options,
        ...queryKey[0],
        signal,
        throwOnError: true,
    ...
    queryKey: getCodingOperationQueryKey(options),
  })
